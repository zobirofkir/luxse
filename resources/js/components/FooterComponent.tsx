  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* About */}
        <div>
          <h3 className="text-xl font-semibold mb-4 uppercase tracking-widest">
            {t.aboutTitle}
          </h3>
        ...
        <div>
          ...
          <div className="flex space-x-6 text-white" style={{ justifyContent: language === "ar" ? "flex-end" : "flex-start" }}>
            {/* Facebook */}
            <a
              href="#"
              aria-label="Facebook"
      ...
      <div className="mt-10 border-t border-white/30 pt-6 text-center text-xs text-white/70 space-y-1">
        <div>{t.copyright.replace("{year}", year.toString())}</div>
        <div>
          {t.createdByText}{" "}
          <a
            href={t.createdByLinkUrl}
            target="_blank"
